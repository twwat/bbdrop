...
class ImageHostConfigPanel(QWidget):
    ...
    def _create_credentials_group(self) -> QGroupBox:
        ...
        encryption_note = QLabel(
            ...
            " (AES-128-CBC + HMAC-SHA256) using a key derived from"
            " your hostname, then stored in your OS keyring (Windows"
            " Credential Manager / macOS Keychain / Linux Secret"
            " Service).<br><br>They are tied to your user account and"
