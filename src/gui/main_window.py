...
class BBDropGUI(QMainWindow):
    ...
    def resizeEvent(self, event):
        """Pass through to QMainWindow's default resize handling."""
    ...
    def setup_ui(self):
        ...
        # Construct dock-based layout (queue centralWidget + 6 dockable panels)
    ...
    def _refresh_file_host_widgets_for_db_id(self, db_id: int):
        ...
        self.file_host_controller._refresh_file_host_widgets_for_db_id(db_id)
    ...
    def _update_specific_gallery_display(self, path: str, _retry_count: int = 0):
        ...
        self.gallery_table_controller._update_specific_gallery_display(path, _retry_count)
    ...
    def start_upload_for_item(self, path: str):
        ...
        return self.file_host_controller.start_upload_for_item(path)

    def _on_file_host_icon_clicked(self, gallery_path: str, host_name: str):
        """Handle file host icon click."""
        self.file_host_controller._on_file_host_icon_clicked(gallery_path, host_name)

    def _queue_file_host_upload(self, gallery_path: str, host_name: str, display_name: str):
        """Queue a file host upload for a gallery."""
        self.file_host_controller._queue_file_host_upload(gallery_path, host_name, display_name)
    ...
    def _live_check_file_host(self, gallery_path: str, host_name: str, display_name: str, parent_dialog=None):
        ...
        self.file_host_controller._live_check_file_host(gallery_path, host_name, display_name, parent_dialog)
    ...
    def _handle_missing_gallery_folder(self, gallery_path: str, host_name: str) -> Optional[str]:
        ...
        return self.file_host_controller._handle_missing_gallery_folder(gallery_path, host_name)
    ...
    def _check_sibling_galleries(self, old_parent: str, new_parent: str, already_relocated: str):
        ...
        self.file_host_controller._check_sibling_galleries(old_parent, new_parent, already_relocated)

    def _on_file_hosts_manage_clicked(self, gallery_path: str):
        """Handle 'Manage' button click - show File Host Details Dialog."""
        self.file_host_controller._on_file_hosts_manage_clicked(gallery_path)

    def _on_file_hosts_enabled_changed(self, _enabled_worker_ids: list):
        """Refresh all file host widgets when enabled hosts change."""
        self.file_host_controller._on_file_hosts_enabled_changed(_enabled_worker_ids)
    ...
    def _handle_action_button(self, path: str, action: str) -> None:
        ...
        self.file_host_controller._handle_action_button(path, action)

    def _handle_file_host_click(self, path: str, host_name: str) -> None:
        """Handle file host icon clicks from delegate."""
        self.file_host_controller._handle_file_host_click(path, host_name)
    ...
    def _on_file_host_icon_right_clicked(self, gallery_path: str, host_name: str, global_pos):
        ...
        self.file_host_controller._on_file_host_icon_right_clicked(gallery_path, host_name, global_pos)
    ...
    def _on_file_host_icon_double_clicked(self, gallery_path: str, host_name: str):
        ...
        self.file_host_controller._on_file_host_icon_double_clicked(gallery_path, host_name)
    ...
    def _populate_column_data(self, column_index: int):
        ...
        self.gallery_table_controller._populate_column_data(column_index)
    ...
    def on_gallery_cell_clicked(self, row, column):
        ...
        self.gallery_table_controller.on_gallery_cell_clicked(row, column)
    ...
    def update_gallery_template(self, row, gallery_path, new_template, combo_widget):
        ...
        self.gallery_table_controller.update_gallery_template(row, gallery_path, new_template, combo_widget)
    ...
    def set_image_host_for_galleries(self, gallery_paths: list, host_id: str):
        ...
        self.gallery_table_controller.set_image_host_for_galleries(gallery_paths, host_id)

    def _on_table_item_changed(self, item):
        """Handle table item changes to persist custom columns"""
        self.gallery_table_controller._on_table_item_changed(item)
