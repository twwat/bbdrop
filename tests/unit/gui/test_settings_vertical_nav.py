...
class TestVerticalNavLayout:
    ...
    @patch('src.gui.settings.settings_dialog.load_user_defaults', return_value={})
    @patch('src.gui.settings.settings_dialog.get_config_path', return_value='/tmp/test.ini')
